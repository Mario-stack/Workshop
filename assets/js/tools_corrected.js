...
!(function () {
    ...
    /**
     * ! - - - - - - - - - - - - - - - -
     * ! Das fängt mal mitten im Code an?
     * ! Variablendeklarationen stehen besser am Anfang eines Scopes.
     * ! Die Dokumentation der Funktion callback() ist unvollständig
     * ! - - - - - - - - - - - - - - - - */
    ...
    function callback(event) {
        try {
            ...
            /** 
             * ! - - - - - - - - - - - - - - - -
             * ! Das length ist unspezifisch, was möchtest du denn damit erreichen?
             * ! Hier wäre ggf. ein erläuternder Kommentar für da Verständnis wichtig.
             * ! - - - - - - - - - - - - - - - - */
            ...
            switch (request.readyState) {
                ...
                case 4:
                    ...
                    if (request.status === 200 || request.status === 304) {
                        ...
                        /**
                         * ! - - - - - - - - - - - - - - - -
                         * ! Der Selektor "content" ist nicht generisch und sollte deshalb als Parameter übergeben werden.
                         * ! - - - - - - - - - - - - - - - -
                         */
    ...
    function loadContent(url, context) {
         ...
         * ! Der Eventlistener gehört in app.js in die main-Sektion, er nimmt ja Bezug auf das Dokument.
         * ! tools.js ist rein generischer Code.
         * ! loadContent() soll dann auch nur Content laden und nicht Events setzen 
         * ! - - - - - - - - - - - - - - - - */
        try {
